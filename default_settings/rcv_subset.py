...
def rcv_8020():
	...
	db["train_data_file_name"]="./datasets/rcv/subset_rest/train.csv"
	db["train_label_file_name"]="./datasets/rcv/subset_rest/train_label.csv"
	db["test_data_file_name"]="./datasets/rcv/rcv.csv"
	db["test_label_file_name"]="./datasets/rcv/rcv_label.csv"
