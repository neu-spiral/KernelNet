...
def face_8020():
	...
	db["train_data_file_name"]="./datasets/face/train_test/train.csv"
	db["train_label_file_name"]="./datasets/face/train_test/train_label.csv"
	db["test_data_file_name"]="./datasets/face/train_test/test.csv"
	db["test_label_file_name"]="./datasets/face/train_test/test_label.csv"
