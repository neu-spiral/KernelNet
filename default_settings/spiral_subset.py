...
def spiral_subset():
	...
	db["train_data_file_name"]="./datasets/spiral/subset_rest/train.csv"
	db["train_label_file_name"]="./datasets/spiral/subset_rest/train_label.csv"
	db["test_data_file_name"]="./datasets/spiral/spiral.csv"
	db["test_label_file_name"]="./datasets/spiral/spiral.csv"
